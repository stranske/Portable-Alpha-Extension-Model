...
- Summary tables report annualised terminal_AnnReturn, companion
  terminal_AnnReturn_P10/P50/P90 percentiles, monthly_AnnVol, monthly_TE, and
  monthly_TE_PerPath; probabilities and counts are unitless.
...
CONFIG_TIME_HORIZON_FIELDS: dict[str, str] = {
    ...
    "internal_pa_financing_mean_month": "monthly",
    "internal_pa_financing_sigma_month": "monthly",
    "internal_pa_financing_series": "monthly",
    ...
    "sleeve_max_breach": "monthly",
    "sleeve_max_cvar": "monthly",
    "financing_term_months": "months",
    "sleeve_max_shortfall": "annual",
}
