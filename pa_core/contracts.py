...
SUMMARY_ANN_RETURN_P50_COLUMN = "terminal_AnnReturn_P50"
SUMMARY_ANN_RETURN_P10_COLUMN = "terminal_AnnReturn_P10"
SUMMARY_ANN_RETURN_P90_COLUMN = "terminal_AnnReturn_P90"
...
SUMMARY_TE_PER_PATH_COLUMN = "monthly_TE_PerPath"
SUMMARY_TRACKING_ERROR_LEGACY_COLUMN = "TrackingErr"
SUMMARY_CVAR_COLUMN = "monthly_CVaR"
SUMMARY_CVAR_SE_COLUMN = "monthly_CVaR_SE"
SUMMARY_CVAR_CI95_LOW_COLUMN = "monthly_CVaR_CI95_Low"
SUMMARY_CVAR_CI95_HIGH_COLUMN = "monthly_CVaR_CI95_High"
SUMMARY_CVAR_TERMINAL_COLUMN = "terminal_CVaR"
SUMMARY_TERMINAL_CVAR_SE_COLUMN = "terminal_CVaR_SE"
SUMMARY_TERMINAL_CVAR_CI95_LOW_COLUMN = "terminal_CVaR_CI95_Low"
SUMMARY_TERMINAL_CVAR_CI95_HIGH_COLUMN = "terminal_CVaR_CI95_High"
SUMMARY_TERMINAL_CVAR_HALF_SAMPLE_DELTA_COLUMN = "terminal_CVaR_HalfSampleDelta"
...
SUMMARY_REQUIRED_COLUMNS: Sequence[str] = (
    ...
    SUMMARY_ANN_RETURN_P50_COLUMN,
    SUMMARY_ANN_RETURN_P10_COLUMN,
    SUMMARY_ANN_RETURN_P90_COLUMN,
...
SUMMARY_COLUMN_TYPES: Mapping[str, str] = {
    ...
    SUMMARY_ANN_RETURN_P50_COLUMN: "number",
    SUMMARY_ANN_RETURN_P10_COLUMN: "number",
    SUMMARY_ANN_RETURN_P90_COLUMN: "number",
    SUMMARY_EXCESS_RETURN_COLUMN: "number",
    SUMMARY_ANN_VOL_COLUMN: "number",
    SUMMARY_VAR_COLUMN: "number",
    SUMMARY_CVAR_COLUMN: "number",
    SUMMARY_CVAR_SE_COLUMN: "number",
    SUMMARY_CVAR_CI95_LOW_COLUMN: "number",
    SUMMARY_CVAR_CI95_HIGH_COLUMN: "number",
    SUMMARY_CVAR_TERMINAL_COLUMN: "number",
    SUMMARY_TERMINAL_CVAR_SE_COLUMN: "number",
    SUMMARY_TERMINAL_CVAR_CI95_LOW_COLUMN: "number",
    SUMMARY_TERMINAL_CVAR_CI95_HIGH_COLUMN: "number",
    SUMMARY_TERMINAL_CVAR_HALF_SAMPLE_DELTA_COLUMN: "number",
    ...
    SUMMARY_TE_PER_PATH_COLUMN: "number",
}
