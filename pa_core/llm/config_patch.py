...
def validate_patch_schema(raw_patch: Any) -> PatchSchemaValidationResult:
    ...
    unknown_patch_ops = sorted({str(key) for key in raw_patch.keys() if key not in _PATCH_KEYS})
