...
class TestCapitalAllocationValidation:
    ...
    def test_margin_requirement_schedule_interpolation_from_path(self, tmp_path: Path):
...
class TestPortfolioConstraintSuggestions:
    ...
    def test_weight_bounds_suggestion(self) -> None:
        ...
        message = next(r.message for r in results if "portfolio weight for A" in r.message)
